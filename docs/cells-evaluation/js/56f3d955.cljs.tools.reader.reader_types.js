...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45716 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45716(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45721 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45721(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45722 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45722(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45723 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45723(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45728 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45728(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45729 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45729(reader);
}
});
...
var G__45744 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45745 = s.append(c);
c = G__45744;
s = G__45745;
continue;
}
