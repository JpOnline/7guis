...
var digit_47220 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_47221__$1 = (vlq >>> (5));
while(true){
if((vlq_47221__$1 > (0))){
var digit_47225__$1 = (digit_47220 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_47225__$1));

var G__47226 = (vlq_47221__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__47227 = (vlq_47221__$1 >>> (5));
digit_47220 = G__47226;
vlq_47221__$1 = G__47227;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_47220));
}
break;
}
...
var G__47232 = i__$1;
var G__47233 = result__$1;
var G__47234 = shift__$1;
i = G__47232;
result = G__47233;
shift = G__47234;
continue;
