...
var G__27897 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__27897;
continue;
} else {
return ch;
...
var vec__27837 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27837,(0),null);
return (match === s);
});
...
var G__27918 = (i__4737__auto___27917 + (1));
i__4737__auto___27917 = G__27918;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq27893){
...
return (function() { 
var G__27920__delegate = function (rdr,_){
...
var G__27920 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27921__i = 0, G__27921__a = new Array(arguments.length -  1);
while (G__27921__i < G__27921__a.length) {G__27921__a[G__27921__i] = arguments[G__27921__i + 1]; ++G__27921__i;}
  _ = new cljs.core.IndexedSeq(G__27921__a,0,null);
} 
return G__27920__delegate.call(this,rdr,_);};
G__27920.cljs$lang$maxFixedArity = 1;
G__27920.cljs$lang$applyTo = (function (arglist__27922){
var rdr = cljs.core.first(arglist__27922);
var _ = cljs.core.rest(arglist__27922);
return G__27920__delegate(rdr,_);
});
