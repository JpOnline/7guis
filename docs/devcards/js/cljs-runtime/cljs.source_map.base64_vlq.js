...
var digit_35797 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_35798__$1 = (vlq >>> (5));
while(true){
if((vlq_35798__$1 > (0))){
var digit_35799__$1 = (digit_35797 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_35799__$1));

var G__35800 = (vlq_35798__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__35801 = (vlq_35798__$1 >>> (5));
digit_35797 = G__35800;
vlq_35798__$1 = G__35801;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_35797));
}
break;
}
...
var G__35808 = i__$1;
var G__35809 = result__$1;
var G__35810 = shift__$1;
i = G__35808;
result = G__35809;
shift = G__35810;
continue;
