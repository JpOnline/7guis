...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27470 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27470(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27471 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27471(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27472 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27472(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27475 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27475(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27476 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27476(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27480 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27480(reader);
}
});
...
var G__27498 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27499 = s.append(c);
c = G__27498;
s = G__27499;
continue;
}
