...
var G__37060 = o;
goog.object.set(G__37060,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__37133.cljs$lang$applyTo = (function (arglist__37138){
...
var G__37061 = o;
goog.object.set(G__37061,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37142__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37144__i < G__37144__a.length) {G__37144__a[G__37144__i] = arguments[G__37144__i + 0]; ++G__37144__i;}
  args = new cljs.core.IndexedSeq(G__37144__a,0,null);
} 
return G__37142__delegate.call(this,args);};
G__37142.cljs$lang$maxFixedArity = 0;
G__37142.cljs$lang$applyTo = (function (arglist__37145){
var args = cljs.core.seq(arglist__37145);
return G__37142__delegate(args);
});
...
var G__37062 = props;
var G__37062__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37062,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37062);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37062__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37063 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37063,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37063;
}
})(),id_class);
...
var G__37064 = (cljs.core.count(argv) - first_child);
switch (G__37064) {
case (0):
...
var vec__37065 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37065,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37065,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37065,(2),null);
...
var temp__5739__auto___37162 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___37162 == null)){
} else {
var key_37163 = temp__5739__auto___37162;
(jsprops.key = key_37163);
}
...
var temp__5739__auto___37164 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___37164 == null)){
} else {
var key_37165 = temp__5739__auto___37164;
(jsprops.key = key_37165);
}
...
var temp__5739__auto___37167 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___37167 == null)){
} else {
var key_37168 = temp__5739__auto___37167;
(jsprops.key = key_37168);
}
...
var temp__5739__auto___37182 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___37182 == null)){
} else {
var key_37183 = temp__5739__auto___37182;
(jsprops.key = key_37183);
}
...
var temp__5739__auto___37184 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___37184 == null)){
} else {
var key_37185 = temp__5739__auto___37184;
(jsprops.key = key_37185);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37076_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37076_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37078 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37078,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37078,(1),null);
...
break;
default:
var G__37191 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37192 = compiler;
v = G__37191;
compiler = G__37192;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37089 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37089 = (function (opts,id,fn_to_element,meta37090){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37089.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37091,meta37090__$1){
var self__ = this;
var _37091__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37089(self__.opts,self__.id,self__.fn_to_element,meta37090__$1));
}));

(reagent.impl.template.t_reagent$impl$template37089.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37091){
var self__ = this;
var _37091__$1 = this;
return self__.meta37090;
}));

(reagent.impl.template.t_reagent$impl$template37089.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37089.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37089.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37089.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37089.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta37090","meta37090",-1899808729,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37089.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37089.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37089");

(reagent.impl.template.t_reagent$impl$template37089.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template37089");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37089.
 */
reagent.impl.template.__GT_t_reagent$impl$template37089 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37089(opts__$1,id__$1,fn_to_element__$1,meta37090){
return (new reagent.impl.template.t_reagent$impl$template37089(opts__$1,id__$1,fn_to_element__$1,meta37090));
});

}

return (new reagent.impl.template.t_reagent$impl$template37089(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
