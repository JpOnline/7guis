...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__37092){
var vec__37093 = p__37092;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37093,(0),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__37096_SHARP_){
return (((p1__37096_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__37096_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__37097,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__37097;
}
});
...
var G__37150 = (i__4737__auto___37148 + (1));
i__4737__auto___37148 = G__37150;
continue;
} else {
}
break;
...
var G__37104 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37104,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__37104;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq37100){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq37100));
}));
...
var vec__37109 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__37115 = cljs.core.ffirst(matches);
var fexpr__37114 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__37114.cljs$core$IFn$_invoke$arity$1 ? fexpr__37114.cljs$core$IFn$_invoke$arity$1(G__37115) : fexpr__37114.call(null,G__37115));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37109,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37109,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__37107_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__37107_SHARP_))){
return p1__37107_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__37108_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__37108_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__37129){
var vec__37130 = p__37129;
var seq__37131 = cljs.core.seq(vec__37130);
var first__37132 = cljs.core.first(seq__37131);
var seq__37131__$1 = cljs.core.next(seq__37131);
var tag = first__37132;
var content = seq__37131__$1;
...
var vec__37134 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37134,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37134,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37134,(2),null);
