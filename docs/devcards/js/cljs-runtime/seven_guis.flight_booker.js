...
seven_guis.flight_booker.disable_return_QMARK_ = (function seven_guis$flight_booker$disable_return_QMARK_(p__38810){
...
var return_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38811__$1,new cljs.core.Keyword(null,"return?","return?",1616989313));
...
var vec__38842 = cljs.core.re_find(/(\d\d)\D(\d\d)\D(\d\d\d\d)/,date_string);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38842,(0),null);
var day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38842,(1),null);
var month = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38842,(2),null);
var year = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38842,(3),null);
...
var vec__38872 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [date.getDate(),(date.getMonth() + (1)),date.getFullYear()], null);
var day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38872,(0),null);
var month = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38872,(1),null);
var year = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38872,(2),null);
...
seven_guis.flight_booker.disable_book_button_QMARK_ = (function seven_guis$flight_booker$disable_book_button_QMARK_(p__38876){
...
var return_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38877__$1,new cljs.core.Keyword(null,"return?","return?",1616989313));
var start_date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38877__$1,new cljs.core.Keyword(null,"start-date","start-date",295168731));
var return_date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38877__$1,new cljs.core.Keyword(null,"return-date","return-date",520965446));
...
seven_guis.flight_booker.booked_message = (function seven_guis$flight_booker$booked_message(p__38880){
var map__38881 = p__38880;
var map__38881__$1 = (((((!((map__38881 == null))))?(((((map__38881.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38881.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38881):map__38881);
var return_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38881__$1,new cljs.core.Keyword(null,"return?","return?",1616989313));
var start_date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38881__$1,new cljs.core.Keyword(null,"start-date","start-date",295168731));
var return_date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38881__$1,new cljs.core.Keyword(null,"return-date","return-date",520965446));
